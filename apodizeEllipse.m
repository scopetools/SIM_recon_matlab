function [Data_k_space_apodized,apo_ellipse] = apodizeEllipse(Data_k_space,dk_data,p_vec_guess,NA_det,nimm,NA_ext_max,wvl_em,wvl_ext,islattice,norientations)
...
filter=max(cat(4,filter,apo_ellipse),[],4);
end

%Apply apodization filter
Data_k_space_apodized=Data_k_space.*filter;
